            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
              <form>
                <div class="d-flex flex-row align-items-center text-center justify-content-lg-start">
                     <p class="lead fw-normal mb-0 me-3 ">Welcome! Register to PowerUp!</p>
                </div>
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                  <button onClick = {handleRegister} type="button" class="btn btn-primary btn-lg"
                    style={{ paddingLeft: '2.5rem', paddingRight: '2.5rem' }}>Register</button>
                  <p class="small fw-bold mt-2 pt-1 mb-0">Do you have an account?
                   <span className="link-danger" ><Link to ="/login" className="login">Login</Link></span></p>
                </div>
              </form>
            </div>
          </div>
