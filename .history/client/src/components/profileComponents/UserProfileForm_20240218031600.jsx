        ...
        {userData.BMI && (
          <>
            <li className="list-group-item d-flex justify-content-between align-items-center">
              BMI Value
              <span className="badge bg-primary rounded-pill">{userData.BMI.bmi || "Not Provided"}</span>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-center">
              BMI Condition
              <span className="badge bg-primary rounded-pill">{userData.BMI.condition || "Not Provided"}</span>
            </li>
          </>
        )}
        {userData.BMR && (
          <>
            <li className="list-group-item d-flex justify-content-between align-items-center">
              BMR (Mifflin-St Jeor)
              <span className="badge bg-primary rounded-pill">{userData.BMR.mifflinStJeor || "Not Provided"}</span>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-center">
              BMR (Harris-Benedict)
              <span className="badge bg-primary rounded-pill">{userData.BMR.harrisBenedict || "Not Provided"}</span>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-center">
              BMR (Schofield)
              <span className="badge bg-primary rounded-pill">{userData.BMR.schofield || "Not Provided"}</span>
            </li>
          </>
        )}
        {userData.TDEE && (
          <li className="list-group-item d-flex justify-content-between align-items-center">
            TDEE
            <span className="badge bg-primary rounded-pill">{userData.TDEE || "Not Provided"}</span>
          </li>
        )}
      </ul>
    );
