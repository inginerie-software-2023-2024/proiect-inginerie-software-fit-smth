...
const UserProfileForm = ({ userData, onSaveChanges }) => {
  ...
  const handleChange = useCallback((e) => {
    ...
    // Exiting edit mode right after a change is made
    setEditMode(false); // This will exit the edit mode immediately after any change
  }, []);
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      setEditMode(false); // Make sure this line is reached
    } catch (error) {
