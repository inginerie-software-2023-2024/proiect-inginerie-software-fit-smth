...
const UserProfileForm = ({ userData, onSaveChanges }) => {
  ...
  const activityLevelOptions = [
    ...
    { value: 'veryActive', label: 'Super active (very hard exercise/sports & physical job or 2x training)' },
  ];
  ...
  const getActivityLevelLabel = (key) => {
    const option = activityLevelOptions.find(o => o.value === key);
              ...
              {editMode ? (
                ...
                <>
                  <div className="user-data mt-3">
                    ...
                    {renderParagraph("Activity level", getActivityLevelLabel(userData.activityLevel))}
                  </div>
                  <div className="calculated-data mt-3">
