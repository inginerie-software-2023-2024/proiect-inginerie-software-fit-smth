...
const UserProfileForm = ({ userData, onSaveChanges }) => {
  ...
  // In UserProfileForm component

  // Update or refresh state to trigger re-render
  const handleSaveChanges = async () => {
    try {
      await onSaveChanges(editedData); // Assuming onSaveChanges updates data in the backend
      setStatus({ type: "success", message: "Changes saved successfully" });
      setEditMode(false); // Exit edit mode

      // Additional step to ensure re-render with updated data
      // Refresh editedData to reflect any changes or reset form state
      setEditedData({ ...userData }); // Consider fetching fresh userData if possible
