  ...
  const handleSaveChanges = () => {
    ...
    onSaveChanges(editedData)
      .then(() => {
        ...
        setEditMode(false); // This line is now properly placed to run after onSaveChanges completes
      })
      .catch((error) => {
      ...
      .finally(() => {
        // If you always want to exit edit mode regardless of success or failure
        setEditMode(false);
      });
  };
