...
const DatePickerInput = ({ selectedDate, setSelectedDate }) => {
  // Determine the class to apply based on whether a date is selected
  const datePickerClass = `form-control centered-datepicker ${selectedDate ? "date-selected" : "date-not-selected"}`;
