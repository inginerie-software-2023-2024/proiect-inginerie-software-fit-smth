...
// Custom Input Component using Bootstrap
const CustomInput = React.forwardRef(({ value, onClick }, ref) => (
  <input
    ...
    value={value}
    ref={ref}
    readOnly // This makes the input behave as a button but retains the Bootstrap input styling
    style={{ textAlign: 'left' }} // Ensure text aligns to the left
  />
));
