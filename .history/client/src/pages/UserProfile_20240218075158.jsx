...
// Assuming this function is called with the correct `updatedData`
const handleSaveChanges = async (updatedData) => {
  ...
  console.log(`Attempting to save changes for ${username}`, updatedData);
  ...
  try {
    ...
    if (success) {
      ...
      const refreshedData = await fetchUserData(username); // Adjust fetchUserData to return data
...
async function fetchUserData(username) {
  try {
    ...
    if (res.data.Status === "Success") {
      ...
      return res.data.data; // Return the data for further handling
    } else {
