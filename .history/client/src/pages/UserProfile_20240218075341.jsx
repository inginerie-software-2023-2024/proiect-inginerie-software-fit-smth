...
async function fetchUserData(username, setData) {
  ...
  try {
    ...
    if (res.data.Status === "Success") {
      // Ensure a new object is always set, even if data might look similar,
      // to trigger React's re-rendering mechanism.
      setData(prevData => {
        // Check if the fetched data is deeply equal to the previous data.
        // This check can be omitted if you're okay with potentially unnecessary re-renders
        // or if your application requires very strict update conditions.
