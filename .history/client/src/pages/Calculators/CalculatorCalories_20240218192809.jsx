...
const CaloriesCalculator = () => {
    ...
    const saveResult = () => {
        ...
        const val = {
            ...
            date: currentDate, // Use the correctly formatted date
            food: [...userList],
            meal_type: mealType
        };
    ...
    const MealTypeSelector = ({ mealType, setMealType }) => (
        <div className="meal-type-select">
            ...
            <div className={`btn-group meal-type-btn-group-spacing`} role="group">
    ...
    return (
        <section>
            <div className="row">
                ...
                <div className="all-rows" style={{ paddingTop: '10px' }}>
