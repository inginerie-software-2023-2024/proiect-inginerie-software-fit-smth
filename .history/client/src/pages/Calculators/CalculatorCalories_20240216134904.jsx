...
const CaloriesCalculator = () => {
    ...
    const setSearchCallback = useCallback((value) => {
        setSearch(value);
    }, [setSearch]); // Dependencies list is crucial for useCallback to be effective

    // Assuming setSearch is wrapped in useCallback where it's defined
    const SearchBar = ({ search, setSearch, handleSearch }) => {
        const handleInputChange = (e) => setSearchCallback(e.target.value);

        // Ensure handleSearch is also stable and doesn't cause re-renders
        ...
        return (
            <form onSubmit={handleSubmit}>
                <div className="input-group mb-3">
                    ...
                    />
                    <button className="input-group-text" id="search-addon">
