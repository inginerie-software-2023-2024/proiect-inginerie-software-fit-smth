...
function BMRCalculator() {
    ...
    return (
        <div className="container mt-5">
            ...
            {bmrResults && (
                <div className="mt-3">
                    <p className="alert alert-success">Mifflin-St Jeor: value={bmrResults.mifflinStJeor} kcal</p>
                    <p className="alert alert-success">Harris-Benedict: value={bmrResults.harrisBenedict} kcal</p>
