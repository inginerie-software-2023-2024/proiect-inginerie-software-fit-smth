...
const CaloriesCalculator = () => {
    ...
    const CalculationResult = ({ result, saveResult, mealType, setMealType }) => {
        ...
        // Nutritional List Component
        const NutritionList = ({ result }) => (
            <ul>
                <li><strong>{formatValue(result.cal)} calories</strong></li>
                <li><strong>{formatValue(result.carbs)} carbs</strong></li>
                <li><strong>{formatValue(result.fat)} fat</strong></li>
                <li><strong>{formatValue(result.protein)} protein</strong></li>
            </ul>
        );
        ...
        return (
            result ? (
                <div className='result'>
                    ...
                    <p>You've eaten <strong>{formatValue(result.q)} grams</strong> today, which means:</p>
                    <NutritionList result={result} />
                    <div className="save-btn" onClick={saveResult}>
                        <button className='btn btn-warning'>Save result</button>
                    </div>
                    {/* Only show when needed based on conditional logic here */}
                    { /* ... conditionally render the meal type selector ... */}
                </div>
            ) : <span></span>
        );
    };
