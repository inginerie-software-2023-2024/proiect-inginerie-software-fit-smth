...
const UserProfile = () => {
  ...
  }, [selectedDate, username, selectedMealType]); // Include selectedMealType in dependency array
  ...
  // Function to render meal type selection dropdown
  const renderMealTypeSelector = () => (
    <div className="meal-type-selector">
      <label htmlFor="mealType">Meal Type: </label>
      <select id="mealType" value={selectedMealType} onChange={e => setSelectedMealType(e.target.value)} className="form-control">
