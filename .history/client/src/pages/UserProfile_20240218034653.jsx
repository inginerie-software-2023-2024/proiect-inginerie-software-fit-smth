...
const UserProfile = () => {
  ...
  const handleSaveChanges = async () => {
    const optimisticUpdatedData = { ...userData, ...editedData }; // Merge edited data into the current user data
    setUserData(optimisticUpdatedData); // Optimistically update the UI
    try {
      ...
      fetchUserData(username, setUserData); // Revert to the original data
