...
const Articles = () => {
    ...
    const handleSearch = (event) => {
        axios.get(`http://localhost:3001/articles/getArticles?searchKey=${values.searchKeyWords}`)
            .then((response) => {
                if (response.data.Status === 'Error') {
                    setArticlesList([])
                } else {
    ...
    const handleSubmit = () => {
        axios.post('http://localhost:3001/articles/add', values)
            .then(res => {
                ...
                axios.get("http://localhost:3001/articles/getArticles")
                    .then((response) => {
                        if (response.data.Status === 'Error') {
                            setArticlesList([])
                        } else {
    ...
    return (
        <section style={{ display: 'flex' }}>
            ...
            <div className='content-articles' style={{ paddingLeft: '40px', paddingTop: '10px' }}>
                <form>
