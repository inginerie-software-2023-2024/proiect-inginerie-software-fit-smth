...
const UserProfile = () => {
  ...
  const renderMealTypeSelector = () => (
    <div className="meal-type-selector d-flex align-items-center">
      <FontAwesomeIcon icon={faUtensils} className="fa-lg text-primary" style={{ marginRight: '10px' }} />
      <select id="mealType" value={selectedMealType} onChange={e => setSelectedMealType(e.target.value)} className="form-control form-control-sm">
