...
const UserProfile = () => {
  ...
  const handleSaveChanges = async (updatedData) => {
    try {
      await updateUserData(username, updatedData, setUserData); // Assuming on `updateUserData` is handled appropriately. 
      console.log('Data updated successfully in backend, re-fetching user data...');
      await fetchUserData(username, setUserData); // Refetch  
    } catch (error) {
