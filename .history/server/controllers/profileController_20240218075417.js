...
export const getProfile = async (req, res) => {
  ...
  try {
    ...
    const activityLevelKey = activityLevelMap[userProfile.activitylevel] || userProfile.activitylevel;
    userProfile.TDEE = calculateTDEE(userProfile.current_weight, userProfile.height, age, userProfile.gender, activityLevelKey);
...
export const updateProfile = async (req, res) => {
  ...
  const username = req.params.username;
  console.log("User Body to update: " + bodyRequired.username);
  ...
  try {
    ...
    updateUserProfile(bodyRequired, iduser);
...
async function updateUserProfile(userData, userId) {
  const formattedDateOfBirth = userData.dateofbirth; // Only valid date format in MySQL
