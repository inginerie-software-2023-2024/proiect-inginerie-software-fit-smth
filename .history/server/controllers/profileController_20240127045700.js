...
export const getProfile = async (req, res) => {
  ...
  try {
    ...
    //console.log(age, userProfile.gender, userProfile.current_weight, userProfile.height, userProfile.bodyFat);
...
function calculateAge(dateOfBirth) {
  console.log(convertDateToYYYYMMDD(dateOfBirth));
  const birthDate = new Date(convertDateToYYYYMMDD(dateOfBirth));
