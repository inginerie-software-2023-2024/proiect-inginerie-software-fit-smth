...
export const addUserMeal = (req, res) => {
    ...
    food.forEach(foodItem => {
        ...
        const query = "INSERT INTO user_meals (username, date, id_aliment, quantity) VALUES (?, ?, ?, ?)";
...
export const getUserMeals = (req, res) => {
    ...
    const query = "SELECT um.*, a.* from user_meals um, alimente a where um.username = ? and a.id = um.id_alimente ORDER BY um.date DESC";
