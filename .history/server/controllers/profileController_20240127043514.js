...
async function updateUserProfile(userData, userId) {
  ...
  await executeQuery(updateQuery, [userData.firstname, userData.lastname, userData.current_weight, userData.goal_weight, formattedDateOfBirth, userData.height, userId]);
}
